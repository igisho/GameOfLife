...
export const MESSAGES: Record<Locale, Messages> = {
  en: {
    ...
    'app.view.label': 'View',
    'app.view.grid': 'Grid',
    'app.view.surface': 'Medium surface',
    'app.view.hologram': 'Hologram',
    'app.view.holoSources': 'Hologram: Sources',
    'app.view.holoField': 'Hologram: Field',
    'app.view.holoDelta': 'Hologram: Delta',
    'app.view.holoAccum': 'Hologram: Accum',
    'app.view.toggle': 'Toggle medium view',
    'app.view.mediumBadge': 'MEDIUM',
    'app.mediumPreview.tab.surface': 'Surface',
    'app.mediumPreview.tab.holographic': 'Holographic',

    'holographic.header.aria': 'About holographic view',
    'holographic.header.help':
      'Holographic view is a compute-heavy, artistic visualization of the medium. It ray-marches a 3D volume and uses temporal accumulation to reveal interference structure driven by the medium field and Conway sources. It is not a physical simulation output and not a true hologram reconstruction.',

    'holographic.aria': 'Holographic medium volume',
    'holographic.zoomIn': 'Zoom in',
    'holographic.zoomOut': 'Zoom out',
    'holographic.resetView': 'Reset view',

    'holographic.sidebar.title': 'Holographic',

    'holographic.controlsHint': 'Drag = rotate · Wheel = zoom',

    'holographic.view.label': 'View',
    'holographic.view.help': 'Switch between the hologram render and debug views (sources, field, delta, and raw accumulation).',
    'holographic.view.hologram': 'Hologram',
    'holographic.view.sources': 'Sources',
    'holographic.view.field': 'Field',
    'holographic.view.delta': 'Delta',
    'holographic.view.accum': 'Accum',

    'holographic.copyDebug': 'Copy debug',
    'holographic.copyDebug.aria': 'Copy hologram debug snapshot',

    'holographic.computeHeavy.title': 'Compute-heavy.',
    'holographic.computeHeavy.body': 'Lower Steps / Grid N if FPS drops or battery heats up.',

    'holographic.tuning.title': 'Tuning',
    'holographic.tuning.steps.label': 'Steps ({{value}})',
    'holographic.tuning.steps.help': 'Ray-march depth steps. Higher = more detail and stability, lower = faster.',
    'holographic.tuning.gridN.label': 'Grid N ({{value}})',
    'holographic.tuning.gridN.help': 'Samples per axis for the source grid. Cost scales roughly with Grid N squared.',
    'holographic.tuning.exposure.label': 'Exposure',
    'holographic.tuning.exposure.help': 'Boosts brightness after accumulation (mostly aesthetic).',
    'holographic.tuning.threshold.label': 'Threshold',
    'holographic.tuning.threshold.help': 'Suppresses weak interference so only stronger nodes emerge.',
    'holographic.tuning.gamma.label': 'Gamma',
    'holographic.tuning.gamma.help': 'Nonlinear contrast of the node emergence; affects sharpness.',
    'holographic.tuning.k.label': 'k',
    'holographic.tuning.k.help': 'Wave number (spatial frequency). Higher = tighter fringes.',
    'holographic.tuning.phaseGain.label': 'Phase gain',
    'holographic.tuning.phaseGain.help': 'How strongly the medium field drives phase shifts.',
    'holographic.tuning.feedbackStable.label': 'Feedback (stable)',
    'holographic.tuning.feedbackStable.help': 'Temporal accumulation feedback in stable regions. Higher = more persistence.',
    'holographic.tuning.feedbackTurb.label': 'Feedback (turb)',
    'holographic.tuning.feedbackTurb.help': 'Temporal accumulation feedback in turbulent regions. Lower = faster response.',
    'holographic.tuning.deltaGain.label': 'Delta gain',
    'holographic.tuning.deltaGain.help': 'How strongly turbulence reduces temporal feedback.',
    'holographic.tuning.sphereR.label': 'Sphere R',
    'holographic.tuning.sphereR.help': 'Base radius of the rendered volume mask.',
    'holographic.tuning.sphereFade.label': 'Sphere fade',
    'holographic.tuning.sphereFade.help': 'How soft the volume edge falloff is. Higher = softer edge.',
  ...
  sk: {
    ...
    'app.view.label': 'Zobrazenie',
    'app.view.grid': 'Mriežka',
    'app.view.surface': 'Povrch média',
    'app.view.hologram': 'Hologram',
    'app.view.holoSources': 'Hologram: Zdroje',
    'app.view.holoField': 'Hologram: Pole',
    'app.view.holoDelta': 'Hologram: Delta',
    'app.view.holoAccum': 'Hologram: Akumulácia',
    'app.view.toggle': 'Prepnuť zobrazenie média',
    'app.view.mediumBadge': 'MÉDIUM',
    'app.mediumPreview.tab.surface': 'Povrch',
    'app.mediumPreview.tab.holographic': 'Holografia',

    'holographic.header.aria': 'O holografickom zobrazení',
    'holographic.header.help':
      'Holografické zobrazenie je výpočtovo náročná, umelecká vizualizácia média. Ray-marchuje 3D objem a používa časovú akumuláciu, aby odhalilo interferenčnú štruktúru riadenú poľom média a Conway zdrojmi. Nie je to fyzikálny výstup simulácie ani „skutočná“ holografická rekonštrukcia.',

    'holographic.aria': 'Holografický objem média',
    'holographic.zoomIn': 'Priblížiť',
    'holographic.zoomOut': 'Oddialiť',
    'holographic.resetView': 'Reset pohľadu',

    'holographic.sidebar.title': 'Holografia',

    'holographic.controlsHint': 'Ťah = otáčanie · Koliesko = zoom',

    'holographic.view.label': 'Zobrazenie',
    'holographic.view.help': 'Prepína medzi hologramom a debug pohľadmi (zdroje, pole, delta a surová akumulácia).',
    'holographic.view.hologram': 'Hologram',
    'holographic.view.sources': 'Zdroje',
    'holographic.view.field': 'Pole',
    'holographic.view.delta': 'Delta',
    'holographic.view.accum': 'Akumulácia',

    'holographic.copyDebug': 'Kopírovať debug',
    'holographic.copyDebug.aria': 'Kopírovať debug snímku hologramu',

    'holographic.computeHeavy.title': 'Výpočtovo náročné.',
    'holographic.computeHeavy.body': 'Ak klesá FPS alebo sa zohrieva batéria, zníž Steps / Grid N.',

    'holographic.tuning.title': 'Ladenie',
    'holographic.tuning.steps.label': 'Steps ({{value}})',
    'holographic.tuning.steps.help': 'Počet krokov ray-marchingu do hĺbky. Viac = detailnejšie, menej = rýchlejšie.',
    'holographic.tuning.gridN.label': 'Grid N ({{value}})',
    'holographic.tuning.gridN.help': 'Vzorky na os pre mriežku zdrojov. Náročnosť rastie približne s Grid N na druhú.',
    'holographic.tuning.exposure.label': 'Expozícia',
    'holographic.tuning.exposure.help': 'Zvýši jas po akumulácii (hlavne estetika).',
    'holographic.tuning.threshold.label': 'Prahovanie',
    'holographic.tuning.threshold.help': 'Potláča slabú interferenciu, aby sa ukazovali len silnejšie uzly.',
    'holographic.tuning.gamma.label': 'Gamma',
    'holographic.tuning.gamma.help': 'Nelineárny kontrast vzniku uzlov; ovplyvňuje ostrosť.',
    'holographic.tuning.k.label': 'k',
    'holographic.tuning.k.help': 'Vlnové číslo (priestorová frekvencia). Vyššie = hustejšie prúžky.',
    'holographic.tuning.phaseGain.label': 'Zisk fázy',
    'holographic.tuning.phaseGain.help': 'Ako silno pole média ovplyvňuje fázové posuny.',
    'holographic.tuning.feedbackStable.label': 'Feedback (stabilné)',
    'holographic.tuning.feedbackStable.help': 'Spätná väzba časovej akumulácie v stabilných oblastiach. Vyššie = väčšia zotrvačnosť.',
    'holographic.tuning.feedbackTurb.label': 'Feedback (turb)',
    'holographic.tuning.feedbackTurb.help': 'Spätná väzba v turbulentných oblastiach. Nižšie = rýchlejšia reakcia.',
    'holographic.tuning.deltaGain.label': 'Zisk delty',
    'holographic.tuning.deltaGain.help': 'Ako silno turbulencia znižuje časový feedback.',
    'holographic.tuning.sphereR.label': 'Polomer gule',
    'holographic.tuning.sphereR.help': 'Základný polomer masky renderovaného objemu.',
    'holographic.tuning.sphereFade.label': 'Rozmazanie okraja',
    'holographic.tuning.sphereFade.help': 'Mäkkosť prechodu na okraji objemu. Viac = jemnejší okraj.',
  ...
  de: {
    ...
    'app.view.label': 'Ansicht',
    'app.view.grid': 'Gitter',
    'app.view.surface': 'Medium-Oberfläche',
    'app.view.hologram': 'Hologramm',
    'app.view.holoSources': 'Hologramm: Quellen',
    'app.view.holoField': 'Hologramm: Feld',
    'app.view.holoDelta': 'Hologramm: Delta',
    'app.view.holoAccum': 'Hologramm: Akkumulation',
    'app.view.toggle': 'Medium-Ansicht umschalten',
    'app.view.mediumBadge': 'MEDIUM',
    'app.mediumPreview.tab.surface': 'Oberfläche',
    'app.mediumPreview.tab.holographic': 'Holografisch',

    'holographic.header.aria': 'Über die holografische Ansicht',
    'holographic.header.help':
      'Die holografische Ansicht ist eine rechenintensive, künstlerische Visualisierung des Mediums. Sie ray-marcht ein 3D-Volumen und nutzt zeitliche Akkumulation, um Interferenzstrukturen sichtbar zu machen, die vom Medium-Feld und den Conway-Quellen getrieben werden. Es ist kein physikalischer Simulationsausgang und keine echte Hologramm-Rekonstruktion.',

    'holographic.aria': 'Holografisches Medium-Volumen',
    'holographic.zoomIn': 'Heranzoomen',
    'holographic.zoomOut': 'Herauszoomen',
    'holographic.resetView': 'Ansicht zurücksetzen',

    'holographic.sidebar.title': 'Holografisch',

    'holographic.controlsHint': 'Ziehen = drehen · Mausrad = zoom',

    'holographic.view.label': 'Ansicht',
    'holographic.view.help': 'Wechselt zwischen Hologramm und Debug-Ansichten (Quellen, Feld, Delta und rohe Akkumulation).',
    'holographic.view.hologram': 'Hologramm',
    'holographic.view.sources': 'Quellen',
    'holographic.view.field': 'Feld',
    'holographic.view.delta': 'Delta',
    'holographic.view.accum': 'Akkumulation',

    'holographic.copyDebug': 'Debug kopieren',
    'holographic.copyDebug.aria': 'Hologramm-Debug-Schnappschuss kopieren',

    'holographic.computeHeavy.title': 'Rechenintensiv.',
    'holographic.computeHeavy.body': 'Wenn FPS sinkt oder der Akku warm wird: Steps / Grid N reduzieren.',

    'holographic.tuning.title': 'Tuning',
    'holographic.tuning.steps.label': 'Steps ({{value}})',
    'holographic.tuning.steps.help': 'Ray-march Schritte entlang der Tiefe. Mehr = mehr Details, weniger = schneller.',
    'holographic.tuning.gridN.label': 'Grid N ({{value}})',
    'holographic.tuning.gridN.help': 'Samples pro Achse im Quellenraster. Kosten skalieren grob mit Grid N im Quadrat.',
    'holographic.tuning.exposure.label': 'Belichtung',
    'holographic.tuning.exposure.help': 'Helligkeits-Boost nach der Akkumulation (meist ästhetisch).',
    'holographic.tuning.threshold.label': 'Schwelle',
    'holographic.tuning.threshold.help': 'Unterdrückt schwache Interferenz, damit nur stärkere Knoten sichtbar werden.',
    'holographic.tuning.gamma.label': 'Gamma',
    'holographic.tuning.gamma.help': 'Nichtlinearer Kontrast der Knotenbildung; beeinflusst die Schärfe.',
    'holographic.tuning.k.label': 'k',
    'holographic.tuning.k.help': 'Wellenzahl (räumliche Frequenz). Höher = dichtere Fransen.',
    'holographic.tuning.phaseGain.label': 'Phasenverstärkung',
    'holographic.tuning.phaseGain.help': 'Wie stark das Medium-Feld Phasenverschiebungen antreibt.',
    'holographic.tuning.feedbackStable.label': 'Feedback (stabil)',
    'holographic.tuning.feedbackStable.help': 'Zeitliches Feedback in stabilen Bereichen. Höher = mehr Persistenz.',
    'holographic.tuning.feedbackTurb.label': 'Feedback (turb)',
    'holographic.tuning.feedbackTurb.help': 'Zeitliches Feedback in turbulenten Bereichen. Niedriger = schnellere Reaktion.',
    'holographic.tuning.deltaGain.label': 'Delta gain',
    'holographic.tuning.deltaGain.help': 'Wie stark Turbulenz das zeitliche Feedback reduziert.',
    'holographic.tuning.sphereR.label': 'Sphäre R',
    'holographic.tuning.sphereR.help': 'Basisradius der Volumenmaske.',
    'holographic.tuning.sphereFade.label': 'Sphäre Fade',
    'holographic.tuning.sphereFade.help': 'Weichheit des Volumenrandes. Höher = weicherer Rand.',
  ...
  fr: {
    ...
    'app.view.label': 'Vue',
    'app.view.grid': 'Grille',
    'app.view.surface': 'Surface du milieu',
    'app.view.hologram': 'Hologramme',
    'app.view.holoSources': 'Hologramme: Sources',
    'app.view.holoField': 'Hologramme: Champ',
    'app.view.holoDelta': 'Hologramme: Delta',
    'app.view.holoAccum': 'Hologramme: Accumulation',
    'app.view.toggle': 'Basculer la vue du milieu',
    'app.view.mediumBadge': 'MILIEU',
    'app.mediumPreview.tab.surface': 'Surface',
    'app.mediumPreview.tab.holographic': 'Holographique',

    'holographic.header.aria': 'A propos de la vue holographique',
    'holographic.header.help':
      'La vue holographique est une visualisation artistique et coûteuse en calcul du milieu. Elle effectue un ray-march sur un volume 3D et utilise une accumulation temporelle pour révéler des structures d’interférence pilotées par le champ du milieu et les sources Conway. Ce n’est pas un résultat physique de simulation ni une vraie reconstruction holographique.',

    'holographic.aria': 'Volume holographique du milieu',
    'holographic.zoomIn': 'Zoomer',
    'holographic.zoomOut': 'Dezoomer',
    'holographic.resetView': 'Reinitialiser la vue',

    'holographic.sidebar.title': 'Holographique',

    'holographic.controlsHint': 'Glisser = rotation · Molette = zoom',

    'holographic.view.label': 'Vue',
    'holographic.view.help': 'Bascule entre l’hologramme et des vues debug (sources, champ, delta et accumulation brute).',
    'holographic.view.hologram': 'Hologramme',
    'holographic.view.sources': 'Sources',
    'holographic.view.field': 'Champ',
    'holographic.view.delta': 'Delta',
    'holographic.view.accum': 'Accumulation',

    'holographic.copyDebug': 'Copier debug',
    'holographic.copyDebug.aria': 'Copier l’instantane debug de l’hologramme',

    'holographic.computeHeavy.title': 'Couteux en calcul.',
    'holographic.computeHeavy.body': 'Si les FPS chutent ou si la batterie chauffe: baisse Steps / Grid N.',

    'holographic.tuning.title': 'Reglages',
    'holographic.tuning.steps.label': 'Steps',
    'holographic.tuning.steps.help': 'Nombre d’etapes de ray-march en profondeur. Plus = plus de details, moins = plus rapide.',
    'holographic.tuning.gridN.label': 'Grid N ({{value}})',
    'holographic.tuning.gridN.help': 'Echantillons par axe pour la grille des sources. Le cout croît environ avec Grid N au carre.',
    'holographic.tuning.exposure.label': 'Exposition',
    'holographic.tuning.exposure.help': 'Amplifie la luminosite apres l’accumulation (surtout esthetique).',
    'holographic.tuning.threshold.label': 'Seuil',
    'holographic.tuning.threshold.help': 'Supprime les interferences faibles pour ne garder que les noeuds plus forts.',
    'holographic.tuning.gamma.label': 'Gamma',
    'holographic.tuning.gamma.help': 'Contraste non lineaire de l’emergence des noeuds; affecte la nettete.',
    'holographic.tuning.k.label': 'k',
    'holographic.tuning.k.help': 'Nombre d’onde (frequence spatiale). Plus = franges plus serrees.',
    'holographic.tuning.phaseGain.label': 'Gain de phase',
    'holographic.tuning.phaseGain.help': 'Intensite avec laquelle le champ du milieu pilote les dephasages.',
    'holographic.tuning.feedbackStable.label': 'Feedback (stable)',
    'holographic.tuning.feedbackStable.help': 'Feedback temporel dans les regions stables. Plus = plus de persistance.',
    'holographic.tuning.feedbackTurb.label': 'Feedback (turb)',
    'holographic.tuning.feedbackTurb.help': 'Feedback temporel dans les regions turbulentes. Plus bas = reponse plus rapide.',
    'holographic.tuning.deltaGain.label': 'Delta gain',
    'holographic.tuning.deltaGain.help': 'Intensite avec laquelle la turbulence reduit le feedback temporel.',
    'holographic.tuning.sphereR.label': 'Sphere R',
    'holographic.tuning.sphereR.help': 'Rayon de base du masque volumique.',
    'holographic.tuning.sphereFade.label': 'Sphere fade',
    'holographic.tuning.sphereFade.help': 'Douceur de la chute au bord du volume. Plus = bord plus doux.',
